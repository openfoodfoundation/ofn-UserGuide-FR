...
* En attente - Lorsque le statut du paiement est "solde dû", le statut de livraison sera en attente \(tant que le paiement n'est pas reçu, la livraison ne peut pas démarrer __dans un modèle de e-commerce classique. Ce processus n'a pas encore été adapté pour le fonctionnement des hubs alimentaires.\)
